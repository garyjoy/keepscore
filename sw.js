...
const FILES = ['./', './index.html', './assets/styles.css', './assets/js/app.js', './assets/js/scoring.js', './assets/js/keyboard.js', './assets/js/players.js', './assets/js/repository.js', './manifest.webmanifest', './assets/icon-192.png', './assets/icon-512.png'];
